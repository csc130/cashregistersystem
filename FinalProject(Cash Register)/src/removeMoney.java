...
public class removeMoney
{
	...
	public removeMoney(double change, Stack<Integer>twenties, Stack<Integer>tens, Stack<Integer>fives,
	...
	public void execute()
	{
		...
		change = Double.valueOf(num.format(change));
	
		int twenties = (int)change / 20;
		int twentiesR = (int)change %20;
		...
		double cents = Double.valueOf(num.format(change - (int)change));
